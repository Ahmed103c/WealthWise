...
export class NavbarComponent implements OnInit {
  ...
  navLinks = [
    ...
    { path: '/main/app-transaction', label: 'Transactions', icon: 'fas fa-exchange-alt' }, // 🔄 Icône pour transactions financières
    { path: '/employees', label: 'Analyses & Statistiques', icon: 'fas fa-chart-pie' }, // 📈 Graphique circulaire pour statistiques
    { path: '/main/app-budget', label: 'Gestion de Budget', icon: 'fas fa-wallet' }, // 💰 Portefeuille pour budget
