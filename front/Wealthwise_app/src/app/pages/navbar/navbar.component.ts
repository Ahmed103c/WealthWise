...
export class NavbarComponent implements OnInit {
  ...
  navLinks = [
    ...
    {
      path: '/main/app-transaction',
      label: 'Transactions',
      icon: 'fas fa-exchange-alt',
    }, // 🔄 Icône pour transactions financières
    {
      path: '/main/app-statistiques',
      label: 'Analyses & Statistiques',
      icon: 'fas fa-chart-pie',
    }, // 📈 Graphique circulaire pour statistiques
    {
      path: '/main/app-budget',
    ...
    },
    {
      ...
      icon: 'fas fa-id-card',
    }, // 🆔 Carte d'identité pour infos perso
